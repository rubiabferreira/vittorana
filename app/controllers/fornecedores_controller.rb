class FornecedoresController < ApplicationController
  ...
  private
    ...
    def fornecedor_params
      params.require(:fornecedor).permit(:nomefantasia, :razaosocial, :endereco, :bairro, :cep, :estado_id, :cidade_id, :tcomercial, :tcelular, :cnpj, :ie, :email, :im, :site, :categoria_id)
    end
end
